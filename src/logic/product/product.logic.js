...
const productLogicMem = {}
productLogicMem.getAllProducts = async (req, res) => {
  return res.status(200).send(arrayProduct)
}

productLogicMem.getProductById = async (req, res) => {
  const { id } = req.params
...
productLogicMem.saveProduct = async (req, res) => {
...
productLogicMem.updateProductById = async (req, res) => {
  const { nombre, descripcion, precio, urlFoto } = req.body
...
productLogicMem.deleteProductById = async (req, res) => {
  const { id } = req.params
...
module.exports = productLogicMem
